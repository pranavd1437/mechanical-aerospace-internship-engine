...
- [x] Keeps only **in-scope US internships and co-ops** (currently mechanical/aerospace, Summer 2027 / Fall 2026)
...
- [ ] 🟢 Better filters — catch more real mechanical/aerospace roles, drop more fakes (`src/intern_engine/filters.py`)
...
### AI features 🧠
- [ ] 🟡 **Description-assisted role checks** — use posting text to recover ambiguous physical-engineering titles without weakening title precision
...
2. **Improve the filters** in `src/intern_engine/filters.py` (what counts as an in-scope internship).
