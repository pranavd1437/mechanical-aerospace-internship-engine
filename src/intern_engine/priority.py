...
# Mechanical/aerospace targets come first for this fork. The existing tech
# list remains below so the default tech and all-discipline modes retain their
# established behavior when a section is capped.
TOP_COMPANIES = [
    "nasa", "spacex", "blue origin", "boeing", "lockheed martin",
    "northrop grumman", "rtx", "raytheon", "pratt & whitney",
    "collins aerospace", "general electric aerospace", "ge aerospace",
    "general dynamics", "l3harris", "honeywell", "anduril", "rocket lab",
    "relativity space", "sierra space", "axiom space", "firefly aerospace",
    "stoke space", "shield ai", "skydio", "hermeus", "moog", "gulfstream",
    "textron", "bell flight", "joby aviation", "archer aviation", "wisk",
    "applied intuition", "tesla", "ford", "general motors", "rivian",
    "lucid motors", "caterpillar", "deere", "siemens", "bosch", "exxonmobil",
