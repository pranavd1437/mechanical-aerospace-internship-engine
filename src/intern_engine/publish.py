...
def write_feed(store_data: dict) -> int:
    ...
    xml = [
        ...
        f"  <title>{escape(cycles_phrase)} {escape(scope_title)} Internships — new roles</title>\n",
...
def write_radar_ics(store_data: dict, cycle: str | None = None) -> int:
    ...
    lines = [
        ...
        f"X-WR-CALDESC:Expected opening dates for {scope_name} internships. Dates come "
