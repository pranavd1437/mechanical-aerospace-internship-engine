...
### 83 open roles (80 listed below) · 22 new this week

4,122 employers tracked · updated Aug 16, 2026 at 13:11 UTC

_53 have a cycle the employer stated · 30 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| Blue Origin | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| Boeing | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| Ford | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| General Motors | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| Honeywell | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| Lockheed Martin | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| Rivian | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| RTX | ~Sep | ~Sep · in ~16d | ⏳ waiting |
| SpaceX | ~Sep | ~Sep · in ~16d | ⏳ waiting |
...
| 🎯 Caterpillar | Jul 01 | dropped Jul 01 · closed | 🗓️ dropped |
...
_Engine (last run): 3,978 of 4,221 registered boards returned successfully across 12 ATS platforms (99% of boards attempted, 94% of the full registry) · completed in 461.1s · 104 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
