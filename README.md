...
4,412 employers tracked · updated Sep 06, 2026 at 15:37 UTC
...
_Engine (last run): 4,020 of 4,519 registered boards returned successfully across 12 ATS platforms (97% of boards attempted, 89% of the full registry) · completed in 337.7s · 94 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
